                    ...
                    {educations.map((edu) => {
                        return (
                            <tr
                                ...
                                key={edu.id}
                            >
                                <td className="px-6 py-3">{edu.start}</td>
                                <td className="px-6 py-3">{edu.end}</td>
                                <td className="px-6 py-3">{edu.name}</td>
                                <td className="px-6 py-3">{edu.major}</td>
                                <td className="px-6 py-3">{edu.degree}</td>
                                <td>
